...
_DESCRIPTIONS = {
    ...
    "get_product_opportunities": "Read durable Account × Product Opportunities reconstructed from the existing append-only production event authority.",
    "get_demand_anchors": "Derive read-only demand anchors from evidence-bound Product Opportunities without creating a second fact source.",
    "get_market_cells": "Derive read-only market cells from demand anchors and pinned product/application context.",
    "evaluate_market_acceptance": "Evaluate read-only market acceptance from verified procurement anchors without treating unverified labels as procurement proof.",
    "get_expansion_state": "Read the current Product Opportunity expansion state reconstructed from durable production events and evidence-bound derived views.",
