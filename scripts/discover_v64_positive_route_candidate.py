...
def _route_source_alias(row: object) -> str | None:
    """Resolve the two historical source names without accepting conflicts."""
...
def select_candidate(portfolio: object, call: Any) -> dict[str, object]:
    ...
    if candidates:
        ...
        return {
            ...
            "route_source_types": sorted({source for item in routes if (source := _route_source_alias(item))}),
