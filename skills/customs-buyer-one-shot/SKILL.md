...
The plugin `.mcp.json` is the cloud production MCP route. Local CLI, `deploy/local/mcp.windows.json`, Windows Runtime, CMD, PowerShell and Python are engineering/acceptance/recovery surfaces only.
